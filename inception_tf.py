...
def prepare_inception_metrics(dataset, parallel, config):
    ...
    try:
        ...
        util.save_pkl((mu_real, sigma_real), dataset + '_inception_moments.pkl')
        mu_real, sigma_real = util.load_pkl(dataset + '_inception_moments.pkl')
